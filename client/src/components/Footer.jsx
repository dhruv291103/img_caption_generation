    ...
    <>
      <footer class="bg-purple-700 text-white">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul class="text-gray-300 dark:text-gray-300 font-medium">
                  ...
                  <li class="mb-4">
                    <a href="/license" class="hover:underline">
                      licensing
                    </a>
                  </li>
                  <li>
                    <a href="/terms-condition" class="hover:underline">
                      Terms &amp; Conditions
                    </a>
                  </li>
                </ul>
          ...
          <hr class="my-6 lg:w-full border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
          <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <a href="https://github.com">
              <button
                ...
                data-twe-ripple-init
                data-twe-ripple-color="light"
                class="mb-2 inline-block rounded-full bg-[#333] p-2 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
              >
                <span class="[&>svg]:h-4 [&>svg]:w-4">
                  <svg
